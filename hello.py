...
def main():
    ...
    product_price_feed_df = pd.read_csv("https://github.com/sunsuzy/pf-calculator/blob/ee807f88dbc06774b9ea5cc7789dd2e71936763e/product_price_feed.csv", delimiter=';', dtype={'priceBar': 'str', 'nettPrice': 'object'}, low_memory=False)
