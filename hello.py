...
def main():
    ...
    product_price_feed_df = pd.read_csv("https://raw.githubusercontent.com/sunsuzy/pf-calculator/master/product%20price%20feed.csv?token=GHSAT0AAAAAACFI563FA7CCR7UOP3AXLHQEZFXW47A", delimiter=';', dtype={'priceBar': 'str', 'nettPrice': 'object'}, low_memory=False)
