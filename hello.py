...
def main():
    ...
    product_price_feed_df = pd.read_csv("https://github.com/sunsuzy/pf-calculator/blob/46f39740fa3cd0acda6067502408c53545095ee3/product_price_feed.csv", delimiter=';', dtype={'priceBar': 'str', 'nettPrice': 'object'}, low_memory=False)
    print_price_feed_df = pd.read_csv("https://github.com/sunsuzy/pf-calculator/blob/46f39740fa3cd0acda6067502408c53545095ee3/print_price_feed.csv", delimiter=';', low_memory=False)
