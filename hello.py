...
def main():
    ...
    product_price_feed_df = pd.read_csv("/volume1/data/IT/Prijs calculators/PF Concept/Feed/product_price_feed.csv", delimiter=';', dtype={'priceBar': 'str', 'nettPrice': 'object'}, low_memory=False)
    print_price_feed_df = pd.read_csv("/volume1/data/IT/Prijs calculators/PF Concept/Feed/print_price_feed.csv", delimiter=';', low_memory=False)
