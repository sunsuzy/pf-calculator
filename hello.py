...
def main():
    ...
    product_price_feed_df = pd.read_csv("https://github.com/sunsuzy/pf-calculator/blob/567e480ba3ef14c8222cb588c113f3278efe08be/product_price_feed.csv", delimiter=';', dtype={'priceBar': 'str', 'nettPrice': 'object'}, low_memory=False)
    print_price_feed_df = pd.read_csv("https://github.com/sunsuzy/pf-calculator/blob/567e480ba3ef14c8222cb588c113f3278efe08be/Print%20price%20feed.csv", delimiter=';', low_memory=False)
